...
<nav class="navbar navbar-inverse visible-xs" data-spy="affix">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" >
      ...
      <ul class="nav navbar-nav" >
        ...
        <li><a href="#"><span class="glyphicon glyphicon-phone"></span> 推播廣告</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-exclamation-sign"></span> 商家隱私設定</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-envelope"></span> 商圈公告</a></li>
        <li><a href="#">登出</a></li>
      </ul>
    </div>
  </div>
